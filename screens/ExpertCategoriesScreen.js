...
const ExpertCategoriesScreen = (props) => {
    const [selectedId, setSelectedId] = useState(null);
    const DATA = [
        {
          "id": "bd7acbea-c1b1-46c2-aed5-3ad53abb28ba",
          "title": "Doctor",
          "bgPath": require("./assets/doctor.jpg")
        },
        {
          "id": "3ac68afc-c605-48d3-a4f8-fbd91aa97f63",
          "title": "Civil Engineer",
          "bgPath": require("./assets/civil.jpg")
        },
        {
          "id": "58694a0f-3da1-471f-bd96-145571e29d72",
          "title": "Chef",
          "bgPath": require("./assets/chef.png")
        },
      ];
      ...
      const renderItem = ({ item }) => {
        return (
          <Item
            item={item}
            onPress={() => props.navigation.navigate('ExpertsScreen')}
          />
        );
      };
...
export default ExpertCategoriesScreen;